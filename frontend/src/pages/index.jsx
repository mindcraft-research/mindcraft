...
/* ── Flask logo SVG (inline) — design moderne avec bulles en ébullition ───── */
const FlaskLogo = ({ size = 16 }) => {
  const sw = size >= 40 ? 1.4 : 1.6
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      {/* Ouverture du col (ligne horizontale du haut) */}
      <path d="M9 3.5h6" stroke="white" strokeWidth={sw} strokeLinecap="round" />
      {/* Corps du flask : col droit + cône élargi + base arrondie */}
      <path
      ...
      />
      {/* Liquide au fond (arrondi) — clipPath pour contenir les bulles */}
      <defs>
