...
const faqs = [
  ...
  { q: "Comment intégrer une tâche externe (PsychoPy, PsyToolkit, etc.) ?", a: "Dans le bloc Tâche expérimentale, allez dans l'onglet \"Tâche externe\". Choisissez le mode iFrame (tâche intégrée dans la page) ou Redirection. Configurez l'URL et le mode de détection de fin (bouton, message postMessage, ou durée)." },
