...
export default function CheckboxCommentQuestion({ question, value, onChange }) {
  ...
  const toggle = (code) => {
    const updated = selectedCodes.includes(code)
      ...
      : [...selectedCodes, code]
    onChange({ choices: updated, comment: commentText })
  }

  const handleCommentChange = (e) => {
    onChange({ choices: selectedCodes, comment: e.target.value })
  }
